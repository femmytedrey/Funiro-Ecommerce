  ...
  <div>
    ...
    <div class="bg-red-50 py-16 relative overflow-hidden pt-32 sm:pt-20">
      ...
      >
        ...
        <div class="mb-5 transform animate-bounce">
          <div
            class="w-16 h-16 md:w-20 md:h-20 mx-auto bg-red-500 rounded-full flex items-center justify-center"
          >
            <svg
    ...
    <div class="max-w-7xl mx-auto px-7 md:px-20 2xl:px-52 py-12">
            ...
            >
              ...
              <div>
                ...
                <p class="text-gray-600 text-sm mt-1">
                  Ensure your card details are correct and has sufficient funds
                </p>
              </div>
            </div>
            <div
      ...
      <div class="mt-12 flex justify-center gap-4 flex-col sm:flex-row">
        ...
        >
          <i
            class="fas fa-redo mr-2 group-hover:rotate-12 transition-transform"
          ></i>
          Retry Payment
        </button>
        <button
        ...
        >
          <i
            class="fas fa-eye mr-2 group-hover:rotate-12 transition-transform"
          ></i>
          View Order
        </button>
      </div>
